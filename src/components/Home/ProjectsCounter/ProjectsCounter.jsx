    ...
    return (
        ...
        >
            <p className='flex flex-col lg:flex-row lg:gap-5 items-center w-55'>
                ...
                <span className='text-center lg:text-left text-sm text-wrap h-10'>Projects <br /> done</span>
            </p>
            <p className='flex flex-col lg:flex-row lg:gap-5 items-center w-55'>
                <span className='text-6xl lg:text-7xl'>04</span>
                <span className='text-center lg:text-left text-sm text-wrap h-10'>Years of  <br />experience</span>
            </p>
            <p className='flex flex-col lg:flex-row lg:gap-5 items-center w-55'>
                <span className='text-6xl lg:text-7xl'>15</span>
                <span className='text-center lg:text-left text-sm text-wrap h-10'>Collaborations <br />with brands</span>
            </p>
        </section>
    )
}